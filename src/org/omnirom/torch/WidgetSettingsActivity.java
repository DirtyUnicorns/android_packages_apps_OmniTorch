...
public class WidgetSettingsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
        ...
        private void updateEnablement() {
                ...
                mStrobeFrequency.setEnabled(!mPreferences.getBoolean(KEY_WIDGET_SOS, false));
        ...
        public void addWidget() {
                ...
                editor.putBoolean("widget_sos_" + mAppWidgetId, mPreferences.getBoolean(KEY_WIDGET_SOS, false));
                editor.commit();
                ...
                if (mPreferences.getBoolean("widget_strobe_" + mAppWidgetId, false)) {
                        ...
                        views.setTextViewText(R.id.ind_text, context.getString(R.string.label_sos));
                }
